...
import { RequestRegisterCodeForm } from "@/types/index";
import { useMutation } from "@tanstack/react-query";
import { requestRegisterCode } from "@/services/AuthApi";
import { toast } from "react-toastify";

export default function RequestNewCodeView() {

    const initialValues: RequestRegisterCodeForm = {
        email: ''
    }
    ...
    const mutation = useMutation({
        mutationFn: requestRegisterCode,
        onSuccess: (response) => {
    ...
    const onSubmit = (formData: RequestRegisterCodeForm) => mutation.mutate(formData)
